(function () {
  ...
  const en = {
    ...
    "财务洞察": "Finance Insights",
    "月度报告": "Monthly Report",
    "用确定性统计查看预算、趋势和异常消费。": "Review budgets, trends, and unusual spending with deterministic statistics.",
    "预算规则": "Budget Rules",
    "刷新报告": "Refresh Report",
    ...
    "未设置": "Not Set",
    "设置预算": "Set Budget",
    "预算与提醒": "Budgets & Alerts",
    "由本地账单和预算规则计算，不依赖模型生成。": "Calculated from local bills and budget rules, not generated by a model.",
    "当前没有需要处理的预算提醒。": "There are no budget alerts to handle.",
    "分类预算": "Category Budgets",
    "为常用分类设定限额，提前看到风险。": "Set limits for common categories and see risk early.",
    "还没有分类预算规则。": "No category budget rules yet.",
    "去设置": "Set Up",
    "异常消费": "Unusual Spending",
    "基于本月中位支出与日支出峰值识别。": "Detected from this month's median transaction and daily-spend peaks.",
    "账单样本中暂无异常消费。": "No unusual spending appears in this month's bills.",
    "本月洞察": "Monthly Insights",
    "确定性统计结论，可直接用于月度复盘。": "Deterministic findings ready for a monthly review.",
    "记录更多账单后，这里会出现消费洞察。": "Spending insights will appear after more bills are recorded.",
    "高频商户": "Frequent Merchants",
    "按本月支出金额排序。": "Ranked by monthly expense amount.",
    "还没有本月商户支出数据。": "There is no merchant expense data this month.",
    "分类预算（选填）": "Category Budgets (Optional)",
    "全局和分类预算达到预警比例时会生成提醒。每行使用“分类=金额”，例如“餐饮=1200”。": "Alerts are created when global or category budgets reach the warning level. Use one rule per line, for example Dining=1200.",
    "分类预算格式不正确，请使用“餐饮=1200”的格式。": "Invalid category budget format. Use Dining=1200.",
