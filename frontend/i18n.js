(function () {
  ...
  const en = {
    ...
    "只编辑管理员自定义条目；内置知识保留在代码里，必要时可用相同 source_id 覆盖。": "Only edit admin custom documents. Built-in documents remain in code and can be overridden with the same source_id.",
