...
def clear_local_data(payload: DataClearRequest, request: Request) -> DataClearResponse:
    ...
    audit_log_store.record(
        ...
        metadata={
            ...
            "reset_category_settings": payload.reset_category_settings,
            "reset_budget_settings": payload.reset_budget_settings,
            "reset_tag_settings": payload.reset_tag_settings,
