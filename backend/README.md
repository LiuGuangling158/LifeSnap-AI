...
Configure Kimi Vision for image bill recognition:

```powershell
$env:LIFESNAP_IMAGE_BILL_API_KEY = "your-kimi-api-key"
...
In `external_http` mode, the backend sends this JSON payload to the endpoint:
